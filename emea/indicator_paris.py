...
class ParisIndicator:
    def __init__(self, data: Data, conf: Config):
        self.conf = conf
        self.data = data
        ...
        # paris_cache_fn = os.path.join(conf.output_dir, "paris_cache.json")
        # paris_cache_arr_fn = os.path.join(conf.output_dir, "paris_cache_arr.npz")
        paris_cache_fn = os.path.join(conf.data_dir, "../paris_cache.json")
